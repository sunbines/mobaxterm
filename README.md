...
本仓库用于整理 MobaXterm 的下载、激活、汉化与参考资料，方便快速查找常用链接和相关说明。MobaXterm 是一款 Windows 平台常用的远程终端工具，集成了 SSH、SFTP、X11 Server、标签页终端等功能，适合日常服务器管理、开发调试和远程运维使用。

## 官网下载

- [MobaXterm Home Edition 下载](https://mobaxterm.mobatek.net/download-home-edition.html)

## MobaXterm 激活

1. 生成激活文件：[MobaXterm Keygen 在线生成](https://jongjeng.github.io/MobaXtermKeygen/index.html)
2. 将激活文件放入 MobaXterm 便携版的根目录中即可

## MobaXterm 汉化

1. [Eilte/Mobaxterm-Chinese](https://github.com/Eilte/Mobaxterm-Chinese)
